var app = (function()
{
	...
	var port = 8080
	var app_uuid="B9407F30-F5F8-466E-AFF9-25556B57FE6D";
	app.connected = false
	app.ready = false
	app.pubTopic = 'lablocator/light' // Device publish topic
	app.subTopic = 'lablocator/light' // Device subscribe topic
	...
	app.setupConnection = function () {
		...
		app.status('Connecting to ' + host + ':' + port + ' as ' + app_uuid)
		app.client = new Paho.MQTT.Client(host, port, app_uuid)
...
///
	...
	function useNewData(data)
	{
		...
		var msg = JSON.stringify(data.light);
		app.publish(msg);
	}
